                                                        ...
                                                        //=========================================
function resetGame(){
    eventBox("Reset Game", "Left Button restarts this run only. Permanent gains from previous lives kept. Right Button resets all progress.");
...
function nyarPostReset() {
    ...
    if (permanentChanges.immortality === true) {
        eventBox('Columns three they marched...', 
        ...
        eventBox('Columns three we marched...', 
...
function darkDevourerPostReset() {
    ...
    eventBox( 'Dark Devourer', devourText.open);
