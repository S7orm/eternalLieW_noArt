...
function expedition(){
    if(vault.gold.current >= 88){
        ...
        eventBox("Far off places...", "Having gathered supplies and weathered maps, West is driven to seek out the lost and isolated places where secrets may be uncovered. (Expeditions unlocked)");
...
function whateley(){
    if(ichorCrafts.whateley.stage===1){
        ...
        if(whateleyPay() === "staged"){
            ...
            eventBox("Childhood", "The writhing mass has grown several hypnotic eyes and a third arm. It whispers to West that only the Black Ship can travel to Kadath. (Dylath-Leen dream expedition unlocked, +444 Vision)");
        ...
        if(whateleyPay() === "staged"){
            ...
            eventBox("Adulthood", "The heaving mass shakes the foundation as it begins to send out telepathic Visons of far off realms and places where space and time collapse. The Faithful fear what this portends. (passive Vision, Madness, and Terror, which grow with each feeding.)");
        }else if (whateleyPay()===true){
        ...
        if(whateleyPay()===true){
            ...
            eventBox("Yog-Sothoth", "Yog-Sothoth knows the gate. Yog-Sothoth is the gate. Yog-Sothoth is the key and guardian of the gate. Past, present, future, all are one in Yog-Sothoth. (Yog-Sothoth in Sacrarium)");
        }
    }
}
