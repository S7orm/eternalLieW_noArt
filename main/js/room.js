...
// Create a copy of the visual peg (now a div with text)
const pegVisual = originalPeg.querySelector('.peg-image, .pegInHole');
if (!pegVisual) return;
const dragCopy = pegVisual.cloneNode(true);
   ...
   // dragCopy.style.pointerEvents = 'none';
    ...
    const rect = pegVisual.getBoundingClientRect();
