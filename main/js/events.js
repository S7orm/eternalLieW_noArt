...
document.getElementById('menuT').addEventListener('pointerdown',  () =>toggleMenu());
...
//localStorage.clear();
    ...
    if (saveTest !== null) {
        ...
        eventBox("A beginning...", "Waking as if out of a dream, dream West stands alone in a darkened alley, hands feverishly clutching an ancient manuscript. A soothing voice in his mind calmly hints at future greatness.");
    }
